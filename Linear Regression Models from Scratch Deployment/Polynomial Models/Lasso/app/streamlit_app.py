...
if st.session_state["show_landing"]:
    st.markdown(
        ...
        <div class="landing-container">
            <div class="landing-title">Polynomial Lasso Regression</div>
...
# Page config
st.set_page_config(page_title="Polynomial Lasso Regression App", layout="centered")
...
with st.expander("📊 Model Performance Metrics"):
    ...
    st.markdown("""
    - **Mean Squared Error (MSE):** 5.2440
    - **Mean Absolute Error (MAE):** 1.8983
    - **R² Score:** 0.9984
    """)

    st.subheader("🎓 Training Metrics")
    st.markdown("""
    - **Mean Squared Error (MSE):** 5.2694
    - **Mean Absolute Error (MAE):** 1.9026
    - **R² Score:** 0.9984
    """)
...
with st.expander("📂 Model Details"):
    ...
    st.write("The L1 regularization parameter was set to 0.2 during training, which seemed helped to prevent overfitting and improve generalization on unseen data.")
...
with st.expander("📚 Dataset Information"):
    st.markdown("**Model:**Polynomial Lasso Regression")
